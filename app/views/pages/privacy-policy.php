...
<div class="flex justify-center">
    <div class="w-full lg:w-2/3 my-6 bg-gray-100 border shadow-lg z-10">
        <div class="p-5 text-center m-5">
            ...
            <p style="text-align: justify;">The following is the privacy policy of google, so with that I will implement on my blog by e-mail address&nbsp;contact@<?= web['domain'] ?>.</p>
            </br>
            ...
            <p style="text-align: justify;">The contents of this statement may be altered at any time, at our discretion. If you have any questions regarding the privacy policy of&nbsp;this site&nbsp;then you may&nbsp;<a href="/p/contact">contact us</a>&nbsp;at contact@<?= web['domain'] ?>.</p>
        </div>
    </div>
